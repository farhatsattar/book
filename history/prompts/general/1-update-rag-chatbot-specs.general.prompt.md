---
id: 1
title: update-rag-chatbot-specs
stage: spec
date: '2025-12-28'
...
files:
  ...
  - ./requirements.md
tests: []
outcome: Specification created for integrated RAG chatbot for published book
evaluation:
  status: complete
  notes: Complete specification with system architecture, RAG flow, and requirements
---
...
update rag chatbot  specs  by this prompt :Integrated RAG Chatbot for Published Book

You are a senior RAG systems architect. Specify a production-ready Retrieval-Augmented Generation chatbot embedded in a published book platform.

Core Requirements

Answer user questions only using book content

Explicitly state "not found in the book" when applicable

Support selected-text mode: answers must rely exclusively on user-highlighted text, bypassing global retrieval

Provide source attribution (chapter/section/page)
...
Serverless, stateless APIs

Data Pipeline

Text extraction → normalization → semantic chunking (500–1000 tokens)
...
Selected-text context overrides all other sources
