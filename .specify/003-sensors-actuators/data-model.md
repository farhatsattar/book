# Data Model: Chapter 3 - Sensors and Actuators in Physical AI

## Entities

### Chapter Content
- **id**: string (unique identifier for the chapter)
- **title**: string (e.g., "Sensors and Actuators in Physical AI")
...
- **sensorType**: string (type of sensor or actuator system)
