...
const config: Config = {
  ...
  tagline: 'A Comprehensive Guide to Integrating AI with Robotics using ROS 2',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      logo: {
        ...
        src: 'img/ai-book.jpg',
        srcDark: 'img/ai-book.jpg', // Add dark mode version if available
        width: 32,
        height: 32,
      },
      items: [
        ...
        {
          href: 'https://github.com/farhatsattar',
          label: 'GitHub',
          position: 'right',
        },
      ],
