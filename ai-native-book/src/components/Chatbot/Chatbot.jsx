...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Hello! I'm your RAG-powered chatbot. How can I help you with the book content today?",
      sender: 'bot',
    },
  ]);
  const [inputValue, setInputValue] = useState('');
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // ✅ Backend URL using import.meta.env
      const API_BASE_URL = import.meta.env.REACT_APP_BACKEND_URL || 'https://book-1-3piy.onrender.com';
      const fullUrl = `${API_BASE_URL}/chat`;
